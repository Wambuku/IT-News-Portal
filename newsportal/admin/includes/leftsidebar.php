...
<?php endif;?>
    ...
    <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span>RSS Feeds </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-subcategory.php">Add RSS Feed</a></li>
                                    <li><a href="manage-subcategories.php">Manage RSS Feeds</a></li>
                                </ul>
                            </li>
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> julietwambuku@gmail.com</p>
                    </div>
