...
if (strlen($_SESSION['login']) == 0) {
    ...
    <head>
        ...
        <title>Newsportal | Add RSS Feed</title>
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box">
                                <h4 class="m-t-0 header-title"><b>Add RSS
                                        <Feed></Feed>
                                    </b></h4>
                                <hr/>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="form-horizontal" name="category" method="post">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">RSS Feed Source</label>
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-2 control-label">RSS Feed URL</label>
                                                <div class="col-md-10">
